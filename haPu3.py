...
#This is a class with two import method.. the callbacks
class Message:
...
def create_gui():
   ...
   # m = Message(oop , message)
    ...
    #message = []
        ...
        # This is done in order to cover any word of length up to 14.
...
#button2 = Button(root, text="House")
